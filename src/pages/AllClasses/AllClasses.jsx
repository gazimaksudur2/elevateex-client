...
const AllClasses = () => {
    ...
    return (
        <div className="pb-8 -mt-10">
            ...
            <p className="text-center text-xl font-semibold py-2">Total Existing course is : {classes?.length}</p>
            ...
            <div className="w-[90%] pt-10 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {
                    classes.map((course, idx) => (<ClassCards key={idx} course={course}/>))
                }
            </div>
        </div>
    );
