...
import { HiOutlineBookOpen, HiOutlineClock, HiOutlineStar, HiOutlineArrowLeft } from 'react-icons/hi';
...
const SingleClass = () => {
  ...
  if (!course && !error) return <div className="min-h-screen flex items-center justify-center"><LoadingState size="lg" text="Loading course…" /></div>;
  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <nav className="bg-white border-b border-surface-200 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
        <Link to="/teacherdash/myclass" className="flex items-center gap-2 text-sm font-medium text-surface-600 hover:text-surface-900 transition-colors">
          <HiOutlineArrowLeft />
          Back to Courses
        </Link>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="card-elevated p-6 space-y-4">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-surface-500 line-clamp-3">{course.course_description}</p>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-surface-100">
            ...
            <div className="flex items-center gap-5 text-sm text-surface-500">
              <span className="flex items-center gap-1.5"><HiOutlineBookOpen className="text-base" />{course.total_lessons} lessons</span>
              <span className="flex items-center gap-1.5"><HiOutlineClock className="text-base" />{course.course_duration}</span>
        ...
        {/* Assignments */}
        <div>
          <h2 className="text-base font-semibold text-surface-900 mb-3">Course Assignments</h2>
